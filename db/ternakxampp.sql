...
--
-- Struktur dan data untuk tabel `pengguna`
--
...
--
-- Struktur dan data untuk tabel `kandang`
--
...
--
-- Struktur dan data untuk tabel `ras`
--
...
--
-- Struktur dan data untuk tabel `kambing`
--
CREATE TABLE IF NOT EXISTS `kambing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_pemilik` int(11) DEFAULT NULL,
  `id_induk` int(11) DEFAULT NULL COMMENT 'FK ke id kambing (induk betina)',
  `id_pejantan` int(11) DEFAULT NULL COMMENT 'FK ke id kambing (pejantan)',
  `id_kandang` int(11) DEFAULT NULL COMMENT 'FK ke tabel kandang',
  `kode_tag` varchar(50) DEFAULT NULL,
  `nama` varchar(50) DEFAULT NULL,
  `jenis_kelamin` enum('jantan','betina') DEFAULT NULL,
  `id_ras` int(11) DEFAULT NULL,
...
--
-- Struktur dan data untuk tabel `reproduksi`
--
CREATE TABLE IF NOT EXISTS `reproduksi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `id_betina` int(11) DEFAULT NULL,
  `id_jantan` int(11) DEFAULT NULL,
...
-- Asumsi ada data INSERT untuk reproduksi (jika ada)

--
-- Struktur dan data untuk tabel `kelahiran`
--
...
-- Asumsi ada data INSERT untuk kelahiran (jika ada)

--
-- Struktur dan data untuk tabel `anak_kambing`
--
CREATE TABLE IF NOT EXISTS `anak_kambing` (
  `id_kelahiran` int(11) NOT NULL,
  `id_kambing_anak` int(11) NOT NULL,
...
-- Asumsi ada data INSERT untuk anak_kambing (jika ada)

--
-- Struktur dan data untuk tabel `kategori_keuangan`
--
...
--
-- Struktur dan data untuk tabel `keuangan`
--
...
--
-- Struktur dan data untuk tabel `notifikasi`
--
...
--
-- Struktur dan data untuk tabel `penjualan`
--
...
--
-- Struktur dan data untuk tabel `riwayat_berat`
--
...
--
-- Struktur dan data untuk tabel `riwayat_kesehatan`
--
...
--
-- Struktur dan data untuk tabel `riwayat_pakan`
--
...
--
-- Struktur dan data untuk tabel `stok_barang`
--
